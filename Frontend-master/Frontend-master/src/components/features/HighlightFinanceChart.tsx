...
const CircularHighlightChart = () => {
  ...
  const renderChart = (isFullscreen: boolean) => (
    <Box sx={{ 
       height: isFullscreen ? '70vh' : (isMobile ? 240 : 360),
      position: 'relative',
      width: '100%'
    }}>
      <ResponsiveContainer>
        <PieChart>
          ...
          <Pie
            ...
            startAngle={90}
            endAngle={-270}
            innerRadius={isFullscreen ? (isMobile ? 80 : 120) : (isMobile ? 60 : 100)}
            outerRadius={isFullscreen ? (isMobile ? 150 : 220) : (isMobile ? 120 : 180)}
            paddingAngle={0}
          >
          ...
          <Pie
            ...
            dataKey="value"
            innerRadius={
              isFullscreen ? (isMobile ? 60 : 80) : (isMobile ? 30 : 60)
            }
            outerRadius={
              isFullscreen ? (isMobile ? 80 : 100) : (isMobile ? 40 : 70)
            }
            startAngle={90}
            endAngle={-270}
          >
