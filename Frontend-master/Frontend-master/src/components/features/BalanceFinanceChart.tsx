...
const data = [
  { name: '68L', value: 68, color: '#FDE68A', textColor: '#1E293B' }, // lighter yellow
  { name: '41L', value: 41, color: '#BFDBFE', textColor: '#1E293B' }, // lighter blue
  { name: '21L', value: 21, color: '#E5E7EB', textColor: '#1E293B' }, // light gray
  { name: '17L', value: 17, color: '#E5E7EB', textColor: '#1E293B' }, // light gray
];

const centerData = [
  { name: 'Variance', value: 45, color: '#FCA5A5' }, // lighter red
  { name: 'Actual', value: 112, color: '#86EFAC' },  // lighter green
];
