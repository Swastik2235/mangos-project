  ...
  const data: CategoryData[] = [
    {
      label: 'Methods',
      items: [
        { label: 'Component 1', primary: 60, secondary: 80, tertiary: 25 },
        { label: 'Component 2', primary: 90, secondary: 100, tertiary: 45 },
        { label: 'Component 3', primary: 100, secondary: 65, tertiary: 10 },
      ]
    },
    {
      label: 'Monetary',
      items: [
        { label: 'Component 1', primary: 90, secondary: 100, tertiary: 45 },
        { label: 'Component 2', primary: 90, secondary: 100, tertiary: 45 },
        { label: 'Component 3', primary: 90, secondary: 100, tertiary: 45 },
        { label: 'Component 4', primary: 90, secondary: 100, tertiary: 45 },
        { label: 'Component 5', primary: 90, secondary: 100, tertiary: 45 },
      ]
    },
    {
      label: 'Management',
      items: [
        { label: 'Component 1', primary: 100, secondary: 65, tertiary: 10 },
        { label: 'Component 2', primary: 100, secondary: 65, tertiary: 10 },
        { label: 'Component 3', primary: 100, secondary: 65, tertiary: 10 },
      ]
    },
    {
